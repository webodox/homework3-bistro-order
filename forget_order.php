...
<title>Order Forgotten - Bistro Order Form</title>
...
<main>
   <h2>Order cleared</h2>
   <div class="card">
      <p>Dessert: (not selected)<br>
         Drink: (not selected)<br>
         Drink size: (not selected)</p>
   </div>

   <div class="actions">
      <a href="index.php" class="btn btn-primary">Return to Form</a>
   </div>
</main>
